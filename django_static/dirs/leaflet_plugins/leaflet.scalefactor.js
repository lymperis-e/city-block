(function (factory, window) {
    ...
    var ScaleFactor = L.Control.extend({
        ...
        _update: function () {
            ...
            //console.log(`Scale init: ${scaleFactor}`)
            scaleFactor = 1000 * Math.round(scaleFactor / 1000);
            //console.log(`scale rounded: ${scaleFactor}`)


            //.replace formats the scale with commas 50000 -> 50,000
            this._mScale.innerHTML = 'Κλίμακα 1:' + scaleFactor.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        }
